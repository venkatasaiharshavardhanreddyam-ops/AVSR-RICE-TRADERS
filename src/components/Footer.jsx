            ...
            <ul className="footer-contact-list">
              <li className="footer-contact-item">
                ...
                <span className="footer-contact-text">
                  <strong>Milling Facility:</strong> 4/53-A, KOTANGURUVAYAPALLI, KHAJIPET, YSR KADAPA.
                </span>
              </li>
              <li className="footer-contact-item">
                <svg className="footer-contact-icon" viewBox="0 0 24 24">
                ...
                <span className="footer-contact-text">
                  <strong>Wholesale Desk:</strong> trading@avsrricetraders@gmail.com
                </span>
              </li>
              <li className="footer-contact-item">
                <svg className="footer-contact-icon" viewBox="0 0 24 24">
                ...
                <span className="footer-contact-text">
                  <strong>Direct Trade Phone:</strong> +91 9949632072 (Direct WhatsApp)
                </span>
              </li>
            </ul>
