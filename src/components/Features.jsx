...
export default function Features() {
  const featuresList = [
    ...
    },
    {
      ...
      text: "Flexible B2B shipping options. Available in 10kg, 25kg, and 50kg bags using premium jute gunny or non-woven materials.",
      // Package box SVG
    ...
    },
    {
      ...
      text: "Eliminating middlemen. Direct-from-source wholesale contracts guarantee highly competitive pricing margins.",
      // Price tag / coin SVG
